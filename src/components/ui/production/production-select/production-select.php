<link rel="stylesheet" href="src/components/ui/production/production-select/production-select.css">
<script type="module" src="src/components/ui/production/production-select/production-select.js"></script>
