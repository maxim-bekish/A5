...
$personalData = [
   ...
   [
      "title" => "2. Основные понятия, используемые \n в Политике",
   ...
   [
      "title" => "3. Основные права и обязанности \n Оператора",
   ...
   [
      "title" => "4. Основные права и обязанности \n субъектов персональных данных",
   ...
   [
      "title" => "5. Принципы обработки персональных \n данных",
   ...
   [
      "title" => "7. Условия обработки персональных \n данных",
   ...
   [
      "title" => "8. Порядок сбора, хранения, передачи \n и других видов обработки персональных \n данных",
   ...
   [
      "title" => "9. Перечень действий, производимых \n Оператором с полученными \n персональными данными",
   ...
   [
      "title" => "11. Конфиденциальность персональных \n данных",
...
<style>
   ...
   .personal-data__table:last-child {
      border-bottom: 1px solid #979797;
   }

   .personal-data__table li {
      padding: 15px 0px;
      margin: 0 20px;
      width: 100%;
   }

   .personal-data__table li:first-child {
      max-width: 307px;
      min-width: 126px;
      border-right: 1px solid #979797;
   }

   .personal-data__table li:last-child {
      list-style-type: disc;
   }

   .personal-data__table:not(:first-child) li:last-child {
      color: #979797;
   }

   .personal-data__table:first-child li:last-child {
      color: #fff;
   }
