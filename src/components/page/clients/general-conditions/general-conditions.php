...
$listTwo =  [
  ...
  [
    "titleBig" => "Государственные субсидии",
    "subTitle" => null,
  ...
  [
    "titleBig" => "Надёжность поставщиков",
    "subTitle" => null,
...
<section class="general-condition general-condition__list-big mt-100px">
  <div class='general-condition__title'>
    ...
    <div class="general-condition__title-right">
      ...
      freeConsultation("Хочу бесплатную консультацию!", "button--blue general-condition__financing-button")
      ?>
    </div>
  </div>
