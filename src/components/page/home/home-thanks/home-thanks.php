...
$slides = [
   [
      "title" => "1 Свидетельство о членстве обьединенной лизинговой ассоциации",
      "date" => "2020",
      "image" => "logo1.svg",
      "text" => null,
      "href" => 'file.pdf'
   ...
   [
      "title" => "2 Благодарность от Объединенной лизинговой ассоциации",
      "date" => "2022",
      "image" => "logo1.svg",
      "text" => null,
      "href" => 'file.pdf'
   ...
   [
      "title" => "3 Свидетельство о членстве Ассоциаций кредитных организаций Тюменской области",
      "date" => "23.10.2023",
      "image" => null,
   ...
   [
      "title" => "4 Благодарственное письмо от ООО «Юнимед»",
      "date" => null,
      "image" => "logo4.png",
      "text" => null,
      "href" => 'file.pdf'
   ...
   [
      "title" => "5 Благодарственное письмо \n от ООО «СК Согласие»",
      "date" => null,
      "image" => "logo5.png",
      "text" => null,
      "href" => 'file.pdf'
