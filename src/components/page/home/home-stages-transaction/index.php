...
<section class="stages-transaction mt-160px container">
   ...
   <div class="stages-transaction-box">
      <div class="stages-transaction-content">
         <hr>

         <div class="stages-transaction-content-item">
            <h4>
      ...
      <button type="button" class="button button-blue">Бесплатная консультация</button>
   </div>
</section>