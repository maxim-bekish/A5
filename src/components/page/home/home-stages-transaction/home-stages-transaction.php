   ...
   <div class="stages-transaction__box">
      <div class="stages-transaction__content">
         ...
         <div class="stages-transaction__item">
            <h4 class="stages-transaction__item-title w-50 ">Подтверждение заявки</h4>
            <p class="stages-transaction__item-text w-50 ">
         ...
         <!--<hr class="stages-transaction__separator">-->
         <div class="stages-transaction__item">
            <h4 class="stages-transaction__item-title w-50 ">Подготовка документов</h4>
            <p class="stages-transaction__item-text w-50 ">
         ...
         <!--<hr class="stages-transaction__separator">-->
         <div class="stages-transaction__item">
            <h4 class="stages-transaction__item-title w-50 ">Одобрение и оплата</h4>
            <p class="stages-transaction__item-text w-50 ">
         ...
         <!--<hr class="stages-transaction__separator">-->
         <div class="stages-transaction__item">
            <h4 class="stages-transaction__item-title w-50 ">Передача <br> предмета лизинга</h4>
            <p class="stages-transaction__item-text w-50 ">
