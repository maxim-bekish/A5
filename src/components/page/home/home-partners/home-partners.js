$(document).ready(function () {
  ...
  let slideHeight = Math.ceil(
    $(".partners-box .partners-slider__slide").outerHeight(),
  );
      ...
      $partnersSliderContainer.animate(
        ...
        function () {
          if (parseInt($partnersSliderContainer.css("top")) >= 0) {
            $partnersSliderContainer.css(
              "top",
              -partnersSlideCount * slideHeight + "px",
            );
          }
          isAnimating = false;
        },
  ...
  function partnersNextSlide() {
    if (!isAnimating) {
      ...
      $partnersSliderContainer.animate(
        ...
        function () {
          if (
            parseInt($partnersSliderContainer.css("top")) <=
            -(partnersSlideCount + 1) * slideHeight
          ) {
            $partnersSliderContainer.css("top", -slideHeight + "px");
          }
          isAnimating = false;
